...
const PRODUCTS = [
  {
    slug: "manual",
    title: "화상회의 설명서",
    desc: "현재 구현 내용을 한 문서에 정리",
    bullets: [
      "좌측 컨트롤 바·중앙 스테이지·우측 참가자 패널",
      "플로팅 채팅, 회의방 상세정보 모달",
      "장치/볼륨 옵션, 프로필·사용자 상세, 알림",
    ],
